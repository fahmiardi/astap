<?php
	class Company {
		...
		function getHeader() {
			...
			<html>
				...
				<body style="margin: 0px; text-align: center;">
					<table cellpadding="0" cellspacing="0" width="737" align="center" border="0">			
						<tr>
							<td width="1" bgcolor="#a1a1a1" style="font-size: 1px; color: #a1a1a1;">.</td>
							<td width="735" align="center" style="padding-left: 20px; padding-right: 20px;">
								<div id="wrapper2">
								<div id="content">
									<div id="br1" style="width: 735px; height: 63px;">
										<div style="background: url(./imagea/rafa_02.gif); width:209px; height: 63px; float: left;"></div>
										<div style="background-color: #ffffff; width:345px; height: 63px; float: left;"></div>
										<div style="background: url(./imagea/rafa_04.gif); width:63px; height: 63px; float: left;"></div>
										<?php
										...
										if($query_ol != null) {
											if(mysql_num_rows($query_ol)==1) {
												...
												if($ol==0) {
													...
													$bg="background: url(./imagea/toko.jpg)";
													$href="page.php?opt=toko";
												}
											}
										}
										?>
										<a href="<?php echo $href; ?>" target="_blank"><div style="<?php echo $bg; ?>; width:118px; height: 63px; float: left; cursor: pointer;">
											</div></a>
										</div>
									<div id="br2" style="width: 735px; height: 90px;">
										<div style="background: url(./imagea/rafa_10.gif); width:105px; height: 90px; float: left;"></div>
										<div style="background: url(./imagea/rafa_11.gif); width:104px; height: 90px; float: left;"></div>
										<div style="background: url(./imagea/rafa_12.gif); width:86px; height: 90px; float: left;"></div>
										<div style="background: url(./imagea/rafa_13.gif); width:91px; height: 90px; float: left;"></div>
										<div style="background: url(./imagea/rafa_14.gif); width:84px; height: 90px; float: left;"></div>
										<div style="background: url(./imagea/rafa_15.gif); width:84px; height: 90px; float: left;"></div>
										<div style="background: url(./imagea/rafa_16.gif); width:93px; height: 90px; float: left;"></div>
										<div style="background: url(./imagea/rafa_17.gif); width:88px; height: 90px; float: left;"></div>
										</div>
									<div id="br3" style="width: 735px; height: 94px;">
										<div style="background: url(./imagea/rafa_19.gif); width:105px; height: 94px; float: left;"></div>
										<div style="background: url(./imagea/rafa_20.gif); width:104px; height: 94px; float: left;"></div>
										<div style="background: url(./imagea/rafa_21.gif); width:86px; height: 94px; float: left;"></div>
										<div style="background: url(./imagea/rafa_22.gif); width:91px; height: 94px; float: left;"></div>
										<div style="background: url(./imagea/rafa_23.gif); width:84px; height: 94px; float: left;"></div>
										<div style="background: url(./imagea/rafa_24.gif); width:84px; height: 94px; float: left;"></div>
										<div style="background: url(./imagea/rafa_25.gif); width:93px; height: 94px; float: left;"></div>
										<div style="background: url(./imagea/rafa_26.gif); width:88px; height: 94px; float: left;"></div>
										</div>
									<div id="br4" style="width: 735px; height: 44px;">
										<div style="background: url(./imagea/rafa_27.gif); width:735px; height: 44px;">
		...
		function getFooter() {
			...
			?>								
								<div id="br6" align="center;">							
									<div style="font-size: 9px; color: #949494; text-align: center; padding-bottom: 10px; width: 250px; float: left;">
										Copyright &copy;2009 <?php echo $DOMAIN; ?><br>Designed and Provided by <a href="http://www.theedgesolution.com" target="_blank"><b>TheEdgeSolution</b></a>
										</div>							
									<div style="text-align: center;"><b><a href="index.php" style="cursor: pointer;">Home</a> | <a href="page.php?opt=info&act=contact" style="cursor: pointer;">Contact</a></b></div>							
									</div>
								</div>
							</div>
							<script type="text/javascript">
		...
		function getContentKiri() {
			?>
			<td width="217" style="padding: 10px 0px 10px 0px;" valign="top">
				...
				<div id="support">
					...
					<div style="text-align: left; padding: 0px 0 0px 0; background: url(./imagea/suport.jpg); width:166px; height: 100px;">
						<div style="color: #ffffff; text-align: right; padding: 40px 5px 0 0;">
							<?php
